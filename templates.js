...
/* ---------- 2. Sosyal Vitrin (dikey) ---------- */
{
  ...
  build(b, T, o) {
    ...
    if (!o.intro) {
      texts.push(
        { text: b.name, start: 0, dur: A, x: 50, y: 38, size: 8, weight: 900,
          color: b.ink, bg: b.accent, bgOn: true, font: b.font, align: 'center' },
        { text: b.tagline, start: 0.3, dur: A - 0.3, x: 50, y: 50, size: 3.4, weight: 500,
          color: b.ink, bg: '#000000', bgOn: false, font: b.font, align: 'center' },
      );
    }
    [b.f1, b.f2, b.f3].forEach((f, i) => {
      texts.push({ text: '✓ ' + f, start: A + each * i, dur: each - 0.1, x: 50, y: 50, size: 6.5,
        weight: 800, color: b.ink, bg: '#000000', bgOn: true, font: b.font, align: 'center' });
    });
    texts.push(
      { text: b.cta, start: T - C, dur: C, x: 50, y: 45, size: 6.5, weight: 900,
        color: b.ink, bg: '#000000', bgOn: false, font: b.font, align: 'center' },
      { text: b.url, start: T - C + 0.2, dur: C - 0.2, x: 50, y: 55, size: 3.8, weight: 700,
        color: b.ink, bg: b.accent, bgOn: true, font: b.font, align: 'center' },
    );
...
/* ---------- 3. Minimal ---------- */
{
  ...
  build(b, T, o) {
    ...
    if (!o.intro) {
      texts.push(
        { text: b.name, start: T * 0.08, dur: T * 0.26, x: 50, y: 50, size: 7.5, weight: 300,
          color: b.ink, bg: '#000000', bgOn: false, font: b.font, align: 'center' },
        { text: b.tagline, start: T * 0.42, dur: T * 0.26, x: 50, y: 50, size: 4.2, weight: 300,
          color: b.ink, bg: '#000000', bgOn: false, font: b.font, align: 'center' },
      );
    } else {
      texts.push(
        { text: b.tagline, start: T * 0.3, dur: T * 0.3, x: 50, y: 50, size: 4.2, weight: 300,
          color: b.ink, bg: '#000000', bgOn: false, font: b.font, align: 'center' },
      );
    }
    texts.push(
      { text: b.url, start: T * 0.76, dur: T * 0.24, x: 50, y: 50, size: 4.6, weight: 600,
        color: b.ink, bg: '#000000', bgOn: false, font: b.font, align: 'center' },
    );
    return {
      texts,
...
/* ---------- 4. Özellik Turu ---------- */
{
  ...
  build(b, T, o) {
    ...
    if (!o.intro) {
      texts.push(
        { text: b.name, start: 0, dur: A, x: 50, y: 48, size: 8, weight: 800,
          color: b.ink, bg: '#000000', bgOn: false, font: b.font, align: 'center' },
        { text: b.tagline, start: 0.3, dur: A - 0.3, x: 50, y: 59, size: 3.4, weight: 400,
          color: b.ink, bg: '#000000', bgOn: false, font: b.font, align: 'center' },
      );
    }
    [b.f1, b.f2, b.f3].forEach((f, i) => {
      ...
      texts.push(
        { text: '0' + (i + 1), start: s, dur: each - 0.15, x: 6, y: 74, size: 7, weight: 900,
          color: b.accent, bg: '#000000', bgOn: false, font: b.font, align: 'left' },
        { text: f, start: s + 0.2, dur: each - 0.35, x: 6, y: 86, size: 4, weight: 600,
          color: b.ink, bg: '#000000', bgOn: true, font: b.font, align: 'left' },
      );
    });
    texts.push(
      { text: b.cta, start: T - C, dur: C, x: 50, y: 45, size: 5.5, weight: 800,
        color: b.ink, bg: '#000000', bgOn: false, font: b.font, align: 'center' },
...
/* ---------- 5. Lansman Duyurusu (kare) ---------- */
{
  ...
  build(b, T, o) {
    ...
    if (!o.intro) {
      texts.push(
        { text: 'YAYINDA', start: 0, dur: T * 0.32, x: 50, y: 42, size: 8, weight: 900,
          color: b.ink, bg: b.accent, bgOn: true, font: b.font, align: 'center' },
        { text: b.name, start: T * 0.1, dur: T * 0.22, x: 50, y: 56, size: 5, weight: 600,
          color: b.ink, bg: '#000000', bgOn: false, font: b.font, align: 'center' },
      );
    }
    texts.push(
      { text: b.tagline, start: T * 0.06, dur: T * 0.34, x: 50, y: 50, size: 5.5, weight: 700,
        color: b.ink, bg: '#000000', bgOn: true, font: b.font, align: 'center' },
      { text: b.cta, start: T * 0.5, dur: T * 0.5, x: 50, y: 44, size: 6, weight: 900,
        color: b.ink, bg: '#000000', bgOn: false, font: b.font, align: 'center' },
      { text: b.url, start: T * 0.56, dur: T * 0.44, x: 50, y: 56, size: 4.2, weight: 700,
        color: b.ink, bg: b.accent, bgOn: true, font: b.font, align: 'center' },
    );
